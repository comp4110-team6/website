                ...
                <div>
                    ...
                    <p class="text text-body font-robo color-purple1">
                        <a class="text-underline color-purple1"
                            href="mailto:deondrejallen@gmail.com">deondrejallen@gmail.com</a><br><br>
                        <a class="text-underline color-purple1" href="https://github.com/DeOndre-Allen">github</a>,
                        <a class="text-underline color-purple1"
                            href="https://www.linkedin.com/in/deondre-allen">linkedin</a>
                    </p>
                </div>
            </div>
            <div style="height: 20px;"></div>
            ...
            <div class="card card_left" name="nmezher">
                ...
                <div>
                    ...
                    <p class="text text-body subtitle font-robo color-purple1">
                        ...
                        likes to fill his free time by playing guitar, watching movies, and hanging out with friends.
                    </p>
                    <div style="height: 15px;"></div>
                    <p class="text text-body font-robo color-purple1">
                        <a class="text-underline color-purple1"
                            href="mailto:noahmezher@gmail.com">noahmezher@gmail.com</a><br><br>
                        <a class="text-underline color-purple1" href="https://github.com/NoahMezher">github</a>,
                        <a class="text-underline color-purple1"
                            href="https://www.linkedin.com/in/noahmezher">linkedin</a>
                    </p>
                </div>
            </div>
            <div style="height: 20px;"></div>
            ...
            <div class="card card_right" name="jsummers">
                <div>
                    ...
                    <p class="text text-body subtitle font-robo color-purple1">
                        ...
                        Part-time Senior, full time nerd. Jack has focused his coursework around Machine Learning and
                        Software Development. To supplement his academics, he participated in an internship for EXFO for
                        two years where he worked as a member of their GUI team. Outside of school and work, his hobbies
                        include 3D printing, Dungeons and Dragons, and hiking!
                    </p>
                    <div style="height: 15px;"></div>
                    <p class="text text-body font-robo color-purple1">
                        <a class="text-underlin color-purple1"
                            href="mailto:jackrsummers@gmail.com">jackrsummers@gmail.com</a><br><br>
                        <a class="text-underline color-purple1" href="https://github.com/Flannelz">github</a>,
                        <a class="text-underline color-purple1"
                            href="https://www.linkedin.com/in/johnsummers-959">linkedin</a>
                    </p>
                </div>
                <div>
            ...
            <div class="card card_left" name="rterravecchia">
                ...
                <div>
                    ...
                    <p class="text text-body font-robo color-purple1">
                        ...
                        <a class="text-underline color-purple1"
                            href="https://www.linkedin.com/in/robert-terravecchia">linkedin</a>
                    </p>
                </div>
            </div>
